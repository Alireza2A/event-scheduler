...
import { getAllEvents, saveEventPersistent } from "../data/events";
  ...
  <FloatingActionButton onClick={() => setIsModalOpen(true)} />
                ...
                <div className="flex flex-col items-center mt-10">
                    ...
                    <div className="flex items-center mt-10">
                        {/* Image Container */}
                        <div className="flex flex-col items-center mt-10">
                            <img src="src/assets/sleepingsloth.png" className="max-h-[50vh] w-auto object-cover overflow-hidden scale-125" style={{ clipPath: "inset(15%)" }} alt="Sleeping Sloth" />
                        </div>
