...
const Footer = () => {
  return (
    <footer className="footer bg-[#27450D] bg-opacity-20 p-10 text-[#48371E] flex flex-wrap justify-between items-start w-full">
      <nav className="flex flex-col gap-2 w-full md:w-auto">
